...
import { Send, User, Bot, FileText, ChevronDown, ChevronRight, Loader2, Square, Search, Brain, Shield, Layers, Zap, CheckCircle2, Lock, Globe, Blend, Filter } from 'lucide-react';
            ...
            <div key={msg.id}>
              {msg.role === 'user' ? (
                ...
                <div className="flex gap-3 group" onClick={() => setActiveMessageId(msg.id)}>
                  ...
                  <div className="flex-1 min-w-0">
                    {/* Model label */}
                    <p className="text-[11px] font-bold text-indigo-500 uppercase tracking-widest mb-2">HyperRAG-X</p>
